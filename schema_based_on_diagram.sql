...
CREATE INDEX idx_medical_history_treatment ON medical_histories_treatments (medical_history_id, treatment_id);
CREATE INDEX idx_invoice_medical_history ON invoices(medical_history_id);
